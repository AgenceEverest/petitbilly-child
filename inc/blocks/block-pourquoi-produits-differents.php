...
/**
 * Block Name: block-pourquoi-produits-differents
 *
 * This is the template that displays 
 * 
 */
if (have_rows('block_pourquoi_produits_differents')) : the_row(); // il s'agit du nom du champ dans ACF qui contient les sous-champs
