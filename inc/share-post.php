<div class="content_width share-date-container">
	...
	<div class="article_share">
		...
		<p class="article_share_icones legende "><span><?php if ($reseaux_sociaux_partager_cet_article) : ?><?php echo $reseaux_sociaux_partager_cet_article; ?><?php endif; ?></span><br>
			<a href="http://www.facebook.com/sharer.php?u=<?php the_permalink(); ?>" title="<?php if ($reseaux_sociaux_partager_sur) : ?><?php echo $reseaux_sociaux_partager_sur; ?><?php endif; ?> Facebook" target="_blank" class="share_button rs_link_item">
				<?= apply_filters('add_svg', 'facebook') ?>
				<?= showSvg(get_stylesheet_directory_uri() . '/svg/fonds-rs.svg'); ?>
			</a>
			<a href="https://twitter.com/share?ref_src=twsrc%5Etfw&url=<?php the_permalink(); ?>" title="<?php if ($reseaux_sociaux_partager_sur) : ?><?php echo $reseaux_sociaux_partager_sur; ?><?php endif; ?> Twitter" target="_blank" class="share_button rs_link_item" data-show-count="false">
				<?= apply_filters('add_svg', 'twitter'); ?>
				<?= showSvg(get_stylesheet_directory_uri() . '/svg/fonds-rs.svg'); ?>
			</a>

			<a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php the_permalink(); ?>" title="<?php if ($reseaux_sociaux_partager_sur) : ?><?php echo $reseaux_sociaux_partager_sur; ?><?php endif; ?> Linkedin" target="_blank" class="share_button rs_link_item">
