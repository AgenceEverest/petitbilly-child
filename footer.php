...
<footer id="footer">
    <div id="footer_wrapper">
        ...
        <p class="rs_link_footer rs_link">
            ...
            <?php if ($page_facebook) : ?>t<a href="<?php echo $page_facebook; ?>" class="rs_link_item" title="<?php if ($reseaux_sociaux_suivez_nous_sur) : ?><?php echo $reseaux_sociaux_suivez_nous_sur; ?><?php endif; ?> Facebook">
