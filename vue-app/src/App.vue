<script>
import ShowCpt from "./components/ShowCpt.vue";
export default {
  name: "App",
  components: {
    ShowCpt,
...
.fond_blanc h1 strong,
.fond_blanc h2 strong,
.fond_blanc h3 strong,
.fond_blanc h4 strong,
.fond_blanc h5 strong,
.fond_blanc h6 strong {
  color: #00693e;
}
.fond_blanc .entry-content h1,
.fond_blanc .entry-content h2,
.fond_blanc .entry-content h3,
.fond_blanc .entry-content h4,
.fond_blanc .entry-content h5,
.fond_blanc .entry-content h6 {
  color: #8cc751;
}
.fond_blanc .entry-content h1 strong,
.fond_blanc .entry-content h2 strong,
.fond_blanc .entry-content h3 strong,
.fond_blanc .entry-content h4 strong,
.fond_blanc .entry-content h5 strong,
.fond_blanc .entry-content h6 strong {
  color: #00693e;
}
.fond_clair h1,
.fond_clair h2,
...
.fond_clair h1 strong,
.fond_clair h2 strong,
.fond_clair h3 strong,
.fond_clair h4 strong,
.fond_clair h5 strong,
.fond_clair h6 strong {
  color: white;
}
.fond_clair .entry-content h1,
.fond_clair .entry-content h2,
.fond_clair .entry-content h3,
.fond_clair .entry-content h4,
.fond_clair .entry-content h5,
.fond_clair .entry-content h6 {
  color: white;
}
.fond_clair .entry-content h1 strong,
.fond_clair .entry-content h2 strong,
.fond_clair .entry-content h3 strong,
.fond_clair .entry-content h4 strong,
.fond_clair .entry-content h5 strong,
.fond_clair .entry-content h6 strong {
  color: white;
}
.fond_clair2 h1,
.fond_clair2 h2,
...
.fond_clair2 h1 strong,
.fond_clair2 h2 strong,
.fond_clair2 h3 strong,
.fond_clair2 h4 strong,
.fond_clair2 h5 strong,
.fond_clair2 h6 strong {
  color: white;
}
.fond_clair2 .entry-content h1,
.fond_clair2 .entry-content h2,
.fond_clair2 .entry-content h3,
.fond_clair2 .entry-content h4,
.fond_clair2 .entry-content h5,
.fond_clair2 .entry-content h6 {
  color: white;
}
.fond_clair2 .entry-content h1 strong,
.fond_clair2 .entry-content h2 strong,
.fond_clair2 .entry-content h3 strong,
.fond_clair2 .entry-content h4 strong,
.fond_clair2 .entry-content h5 strong,
.fond_clair2 .entry-content h6 strong {
  color: white;
}
h2 {
  font-size: 38px;
...
.block-pourquoi-differents h2,
.block-pourquoi-differents h3,
.block-pourquoi-differents h4,
.block-pourquoi-differents h5,
.block-pourquoi-differents h6,
.block-pourquoi-differents p,
.block-pourquoi-differents div,
.block-pourquoi-differents ul,
.block-pourquoi-differents li,
.block-pourquoi-differents a {
  color: white;
}
.block-pourquoi-differents h2 strong,
.block-pourquoi-differents h3 strong,
.block-pourquoi-differents h4 strong,
.block-pourquoi-differents h5 strong,
.block-pourquoi-differents h6 strong,
.block-pourquoi-differents p strong,
.block-pourquoi-differents div strong,
.block-pourquoi-differents ul strong,
.block-pourquoi-differents li strong,
.block-pourquoi-differents a strong {
  color: white;
}
...
.block-nos-recettes-gourmandes h2,
.block-nos-recettes-gourmandes h3,
.block-nos-recettes-gourmandes p {
...
.block-dernieres-recettes .dernieres-recettes .recette h3,
.block-dernieres-recettes .dernieres-recettes .recette a {
  padding-left: 1rem;
  padding-right: 1rem;
}
...
.block-fromages-uniques .green-edge,
.block-fromages-uniques .green-edge-desktop-tall {
  z-index: 1;
  width: 100%;
  height: 100%;
  display: flex;
...
.block-profil-type-recherche h2,
.block-profil-type-recherche h3,
.block-profil-type-recherche h4,
.block-profil-type-recherche h5,
.block-profil-type-recherche h6 {
  color: white !important;
  z-index: 1;
  position: relative;
}
...
.block-profil-type-recherche
  .postes-recherches
  .poste-recherche:nth-child(even) {
  background: white;
}
.block-profil-type-recherche
  .postes-recherches
...
.block-recette
  .recettes-caracteristiques-wrapper
  .part-1-block
  .col-gauche
  .caracteristiques-recettes {
  padding: 10%;
}
.block-recette
  .recettes-caracteristiques-wrapper
...
.multicolonnes_wrapper .avec_bordure ul,
.multicolonnes_wrapper .avec_bordure li,
.multicolonnes_wrapper .avec_bordure a,
.multicolonnes_wrapper .avec_bordure div,
.multicolonnes_wrapper .avec_bordure p {
  color: white !important;
}
...
.rejoignez-nos-equipes .col_flexible_wrapper .col-1,
...
.rejoignez-nos-equipes
  ...
  .postes
  .poste-container:nth-child(odd) {
  background-color: #8cc751;
}
.rejoignez-nos-equipes
  .col_flexible_wrapper
  .postes
  .poste-container:nth-child(even) {
  background-color: #00693e;
}
...
.coldouble_contact_right li,
.coldouble_contact_right a,
.coldouble_contact_right p {
  font-family: "Cafeteria-Bold";
}
.coldouble_contact_right label {
...
.coldouble_contact_right
  ...
  .nf-field-element
  > div,
.coldouble_contact_right .nf-form-content input:not([type="button"]),
.coldouble_contact_right .nf-form-content textarea {
...
.breadcrumb_top span,
.breadcrumb_top .breadcrumb_separator {
  color: black !important;
}
...
.type-post .post_thumbnail .post_thumbnail_image,
.type-post .post_thumbnail .post_thumbnail_texte {
  width: 100%;
}
...
@font-face {
  font-family: "Cafeteria-Regular";
  src: url("../fonts/Cafeteria-Regular.woff2") format("woff2"),
...
@font-face {
  font-family: "Cafeteria-Bold";
  src: url("../fonts/subset-Cafeteria-Bold.woff2") format("woff2"),
    url("../fonts/subset-Cafeteria-Bold.woff") format("woff");
  font-weight: normal;
  font-style: normal;
  font-display: swap;
}
@font-face {
  font-family: "Cafeteria-Black";
  src: url("../fonts/subset-Cafeteria-Black.woff2") format("woff2"),
    url("../fonts/subset-Cafeteria-Black.woff") format("woff");
  font-weight: normal;
  font-style: normal;
  font-display: swap;
}
...
.page_les_actualites .entry_title_bg {
...
.fond_blanc .col_flexible_bordure h1,
.fond_blanc .col_flexible_bordure h2,
.fond_blanc .col_flexible_bordure h3,
.fond_blanc .col_flexible_bordure h4,
.fond_blanc .col_flexible_bordure h5,
.fond_blanc .col_flexible_bordure h6 div,
.fond_blanc .col_flexible_bordure p,
.fond_blanc .col_flexible_bordure ul,
.fond_blanc .col_flexible_bordure li,
.fond_blanc .col_flexible_bordure a {
  color: white;
}
.fond_blanc .col_flexible_bordure h1 strong,
.fond_blanc .col_flexible_bordure h2 strong,
.fond_blanc .col_flexible_bordure h3 strong,
.fond_blanc .col_flexible_bordure h4 strong,
.fond_blanc .col_flexible_bordure h5 strong,
.fond_blanc .col_flexible_bordure h6 div strong,
.fond_blanc .col_flexible_bordure p strong,
.fond_blanc .col_flexible_bordure ul strong,
.fond_blanc .col_flexible_bordure li strong,
.fond_blanc .col_flexible_bordure a strong {
  color: white;
}
.fond_blanc .col_flexible_bordure p {
  color: white;
...
.fond_vert_fonce h1 strong,
.fond_vert_fonce h2 strong,
.fond_vert_fonce h3 strong,
.fond_vert_fonce h4 strong,
.fond_vert_fonce h5 strong,
.fond_vert_fonce h6 strong,
.fond_vert_fonce div strong,
.fond_vert_fonce p strong,
.fond_vert_fonce ul strong,
.fond_vert_fonce li strong,
...
.fond_vert_fonce .col_flexible_bordure h1,
.fond_vert_fonce .col_flexible_bordure h2,
.fond_vert_fonce .col_flexible_bordure h3,
.fond_vert_fonce .col_flexible_bordure h4,
.fond_vert_fonce .col_flexible_bordure h5,
.fond_vert_fonce .col_flexible_bordure h6 {
  color: #8cc751;
}
.fond_vert_fonce .col_flexible_bordure h1 strong,
.fond_vert_fonce .col_flexible_bordure h2 strong,
.fond_vert_fonce .col_flexible_bordure h3 strong,
.fond_vert_fonce .col_flexible_bordure h4 strong,
.fond_vert_fonce .col_flexible_bordure h5 strong,
.fond_vert_fonce .col_flexible_bordure h6 strong {
  color: #00693e;
}
.fond_vert_fonce .col_flexible_bordure div,
.fond_vert_fonce .col_flexible_bordure p,
.fond_vert_fonce .col_flexible_bordure ul,
.fond_vert_fonce .col_flexible_bordure li,
.fond_vert_fonce .col_flexible_bordure a {
  color: black;
}
.fond_vert_fonce .col_flexible_bordure div strong,
.fond_vert_fonce .col_flexible_bordure p strong,
.fond_vert_fonce .col_flexible_bordure ul strong,
.fond_vert_fonce .col_flexible_bordure li strong,
.fond_vert_fonce .col_flexible_bordure a strong {
  color: #00693e;
}
.fond_vert_fonce .col_flexible_bordure p {
  color: black;
...
.fond_vert_clair h1 strong,
.fond_vert_clair h2 strong,
.fond_vert_clair h3 strong,
.fond_vert_clair h4 strong,
.fond_vert_clair h5 strong,
.fond_vert_clair h6 strong,
.fond_vert_clair div strong,
.fond_vert_clair p strong,
.fond_vert_clair ul strong,
.fond_vert_clair li strong,
.fond_vert_clair a strong {
  color: white;
}
.fond_vert_clair p {
  color: white;
...
.fond_vert_clair .col_flexible_bordure h1,
.fond_vert_clair .col_flexible_bordure h2,
.fond_vert_clair .col_flexible_bordure h3,
.fond_vert_clair .col_flexible_bordure h4,
.fond_vert_clair .col_flexible_bordure h5,
.fond_vert_clair .col_flexible_bordure h6 {
  color: #00693e;
}
.fond_vert_clair .col_flexible_bordure h1 strong,
.fond_vert_clair .col_flexible_bordure h2 strong,
.fond_vert_clair .col_flexible_bordure h3 strong,
.fond_vert_clair .col_flexible_bordure h4 strong,
.fond_vert_clair .col_flexible_bordure h5 strong,
.fond_vert_clair .col_flexible_bordure h6 strong {
  color: #00693e;
}
.fond_vert_clair .col_flexible_bordure div,
.fond_vert_clair .col_flexible_bordure p,
.fond_vert_clair .col_flexible_bordure ul,
.fond_vert_clair .col_flexible_bordure li,
.fond_vert_clair .col_flexible_bordure a {
  color: black;
}
.fond_vert_clair .col_flexible_bordure div strong,
.fond_vert_clair .col_flexible_bordure p strong,
.fond_vert_clair .col_flexible_bordure ul strong,
.fond_vert_clair .col_flexible_bordure li strong,
.fond_vert_clair .col_flexible_bordure a strong {
  color: black;
}
.fond_vert_clair .col_flexible_bordure p {
  color: black;
...
.nav_blog_wrapper li,
.nav_blog_wrapper a,
.nav_blog_wrapper span,
.nav_blog_wrapper .nav_blog_title {
  font-family: "Cafeteria-Bold" !important;
}
.rs_link_footer {
  position: absolute;
